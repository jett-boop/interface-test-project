...
def generate_sign():
    ...
    # 钉钉机器人中的加签密钥
    secret = 'SEC5400f7b8428b4817758ad5ea8e10b6ca650dcb90d266d9ffa7ee54d59a3c4718'
...
def send_dd_msg(content_str, at_all=True):
    ...
    url = f'https://oapi.dingtalk.com/robot/send?access_token=a3174f357accae3f5aa32d2c695c0ed0d54fdcb8595302a910eab73ee58b4584&timestamp={timestamp_and_sign[0]}&sign={timestamp_and_sign[1]}'
